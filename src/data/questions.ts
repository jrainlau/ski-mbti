...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '都行，能滑就行，主要看心情', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'V2', score: 1 }] }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '随便套上就走，反正都要摔', weights: [{ dimensionId: 'V2', score: 1 }, { dimensionId: 'T1', score: 1 }] }
    ]
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '那是什么？能吃吗？', weights: [{ dimensionId: 'T2', score: 1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 11,
    ...
    options: [
      ...
      { label: 'C', text: '我从来不拍视频', weights: [{ dimensionId: 'S2', score: 1 }, { dimensionId: 'T1', score: 1 }] }
    ]
  },
  {
    id: 12,
    ...
    options: [
      ...
      { label: 'C', text: '远观即可，我怕死', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'E1', score: 1 }] }
    ]
  },
  {
    id: 13,
    ...
    options: [
      ...
      { label: 'C', text: '哪个好看买哪个', weights: [{ dimensionId: 'V2', score: 2 }, { dimensionId: 'S2', score: 1 }] }
    ]
  },
  {
    id: 14,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '能安全刹停就谢天谢地了', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 20,
    ...
    options: [
      ...
      { label: 'C', text: '一个人也能滑得很开心', weights: [{ dimensionId: 'S1', score: 1 }, { dimensionId: 'T1', score: 1 }] }
    ]
  },
  {
    id: 21,
    ...
    options: [
      ...
      { label: 'C', text: '道外？那不是找死吗', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'A2', score: 1 }] }
    ]
  },
  {
    id: 22,
    ...
    options: [
      ...
      { label: 'C', text: '滑雪！滑都滑不够，哪有时间拍', weights: [{ dimensionId: 'T1', score: 2 }, { dimensionId: 'A1', score: 1 }] }
    ]
  },
  {
    id: 23,
  ...
  },
  {
    ...
    title: '你对护具的态度是？',
    options: [
      { label: 'A', text: '头盔+护甲+护臀+护膝全副武装', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'E1', score: 1 }, { dimensionId: 'E2', score: 1 }] },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '平花是啥？我走路都能摔', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'T1', score: 1 }] }
    ]
  },
  {
    id: 27,
    ...
    options: [
      ...
      { label: 'C', text: '我就犁式刹车选手，能停下来就是胜利', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 28,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '我已经囤了三年的护膝，安全是底线', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'E1', score: 1 }] }
    ]
  },
  {
    id: 30,
    ...
    options: [
      ...
      { label: 'C', text: '天哪好高…我是怎么上来的…能坐缆车下去吗', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  }
]
