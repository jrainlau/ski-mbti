...
export const questions: Question[] = [
  {
    ...
    title: '你到了雪场，第一件事是？',
    options: [
      { label: 'A', text: '先拍张美照发朋友圈"已到战场"', weights: [{ dimensionId: 'S2', score: 2 }, { dimensionId: 'V2', score: 2 }] },
      { label: 'B', text: '换好装备直冲缆车，一秒不浪费', weights: [{ dimensionId: 'A1', score: 1 }, { dimensionId: 'T1', score: 1 }] },
      { label: 'C', text: '找个咖啡厅坐下来先缓缓', weights: [{ dimensionId: 'V1', score: 2 }, { dimensionId: 'T1', score: -1 }] }
    ]
  },
  {
    id: 2,
    ...
    options: [
      ...
      { label: 'C', text: '都行，能滑就行，主要看心情', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'T2', score: -1 }] }
    ]
  },
  {
    id: 3,
    ...
    options: [
      ...
      { label: 'B', text: '点个赞，心里想着"我的也不差"', weights: [{ dimensionId: 'E1', score: 1 }, { dimensionId: 'S1', score: 1 }] },
      { label: 'C', text: '完全不关心，技术才是核心竞争力', weights: [{ dimensionId: 'T1', score: 2 }, { dimensionId: 'E1', score: -1 }] }
    ]
  },
  {
    id: 4,
    ...
    options: [
      ...
      { label: 'C', text: '算了，我还是回蓝道吧，命比面子重要', weights: [{ dimensionId: 'A1', score: -1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 5,
    title: '你滑雪时的穿搭风格是？',
    options: [
      { label: 'A', text: '全身配色精心搭配，雪镜头盔都要好看', weights: [{ dimensionId: 'V2', score: 2 }, { dimensionId: 'E1', score: 1 }, { dimensionId: 'S2', score: 1 }] },
      { label: 'B', text: '功能性第一，什么暖和穿什么', weights: [{ dimensionId: 'E2', score: 1 }, { dimensionId: 'T1', score: 1 }] },
      { label: 'C', text: '随便套上就走，反正都要摔', weights: [{ dimensionId: 'V2', score: -1 }, { dimensionId: 'E1', score: -1 }] }
    ]
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', text: '中档够用，性价比才是王道', weights: [{ dimensionId: 'E1', score: 1 }, { dimensionId: 'E2', score: 1 }] },
      { label: 'C', text: '租的…或者闲鱼淘的', weights: [{ dimensionId: 'E1', score: -2 }, { dimensionId: 'E2', score: -1 }] }
    ]
  },
  {
    id: 8,
    ...
    options: [
      { label: 'A', text: '去！每次去都有新体验', weights: [{ dimensionId: 'A2', score: 1 }, { dimensionId: 'S1', score: 1 }] },
      { label: 'B', text: '看情况，主要看谁去', weights: [{ dimensionId: 'S1', score: 2 }] },
      { label: 'C', text: '算了，在家躺着不好吗', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'S1', score: -1 }] }
    ]
  },
  {
    id: 9,
    ...
    options: [
      ...
      { label: 'C', text: '离家最近的那个就行', weights: [{ dimensionId: 'A2', score: -1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 10,
    ...
    options: [
      ...
      { label: 'C', text: '那是什么？能吃吗？', weights: [{ dimensionId: 'T1', score: -1 }, { dimensionId: 'T2', score: -1 }] }
    ]
  },
  {
    id: 11,
    ...
    options: [
      ...
      { label: 'C', text: '我从来不拍视频', weights: [{ dimensionId: 'S2', score: -2 }] }
    ]
  },
  {
    id: 12,
    ...
    options: [
      ...
      { label: 'C', text: '远观即可，我怕死', weights: [{ dimensionId: 'A1', score: -1 }, { dimensionId: 'E2', score: 1 }] }
    ]
  },
  {
    id: 13,
    ...
    options: [
      ...
      { label: 'C', text: '哪个好看买哪个', weights: [{ dimensionId: 'V2', score: 2 }, { dimensionId: 'E2', score: -1 }] }
    ]
  },
  {
    id: 14,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '该干嘛干嘛，滑雪只是生活的一部分', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'T1', score: -1 }] }
    ]
  },
  {
    id: 16,
    title: '你摔了一个大跟头之后？',
    options: [
      { label: 'A', text: '爬起来继续冲，摔是进步的阶梯', weights: [{ dimensionId: 'A1', score: 2 }, { dimensionId: 'T1', score: 1 }] },
      { label: 'B', text: '先检查自己有没有受伤', weights: [{ dimensionId: 'A1', score: -1 }, { dimensionId: 'E1', score: 1 }] },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', text: '在心里默默鼓励他，但不会上前', weights: [{ dimensionId: 'S1', score: -1 }, { dimensionId: 'V1', score: 1 }] },
  ...
  },
  {
    ...
    title: '关于请教练这件事，你怎么看？',
    options: [
      { label: 'A', text: '必须请！系统学习效率最高', weights: [{ dimensionId: 'T1', score: 2 }, { dimensionId: 'E2', score: 1 }] },
      { label: 'B', text: '看视频自学就行，省钱', weights: [{ dimensionId: 'T1', score: 1 }, { dimensionId: 'E1', score: -1 }] },
      { label: 'C', text: '教练？不需要，我就是来玩的', weights: [{ dimensionId: 'V1', score: 2 }, { dimensionId: 'T1', score: -1 }] }
    ]
  },
  {
    id: 19,
    ...
    options: [
      ...
      { label: 'C', text: '能安全刹停就谢天谢地了', weights: [{ dimensionId: 'A1', score: -1 }, { dimensionId: 'T1', score: -1 }] }
    ]
  },
  {
    id: 20,
    ...
    options: [
      ...
      { label: 'C', text: '一个人也能滑得很开心', weights: [{ dimensionId: 'S1', score: -2 }, { dimensionId: 'T1', score: 1 }] }
    ]
  },
  {
    id: 21,
    ...
    options: [
      ...
      { label: 'C', text: '道外？那不是找死吗', weights: [{ dimensionId: 'A1', score: -2 }, { dimensionId: 'A2', score: -1 }] }
    ]
  },
  {
    id: 22,
    ...
    options: [
      ...
      { label: 'C', text: '滑雪！滑都滑不够，哪有时间拍', weights: [{ dimensionId: 'T1', score: 2 }, { dimensionId: 'S2', score: -1 }] }
    ]
  },
  {
    id: 23,
    ...
    options: [
      ...
      { label: 'C', text: '5 天以内，打个卡就行', weights: [{ dimensionId: 'V1', score: 1 }, { dimensionId: 'T1', score: -1 }] }
    ]
  },
  {
    id: 24,
    title: '你对护具的态度是？',
    options: [
      { label: 'A', text: '头盔+护甲+护臀+护膝全副武装', weights: [{ dimensionId: 'A1', score: -2 }, { dimensionId: 'E1', score: 1 }, { dimensionId: 'E2', score: 1 }] },
      { label: 'B', text: '头盔必须有，其他看情况', weights: [{ dimensionId: 'A1', score: -1 }] },
      { label: 'C', text: '护具？不存在的，影响发挥', weights: [{ dimensionId: 'A1', score: 2 }, { dimensionId: 'E1', score: -1 }] }
    ]
  },
  {
    id: 25,
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'C', text: '平花是啥？我走路都能摔', weights: [{ dimensionId: 'T1', score: -1 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 27,
    ...
    options: [
      ...
      { label: 'B', text: '双板自由式，Mogul / 跳台都想试', weights: [{ dimensionId: 'A1', score: 2 }, { dimensionId: 'T2', score: -1 }] },
      { label: 'C', text: '我就犁式刹车选手，能停下来就是胜利', weights: [{ dimensionId: 'T1', score: -1 }, { dimensionId: 'T2', score: -1 }] }
    ]
  },
  {
    id: 28,
    ...
    options: [
      ...
      { label: 'C', text: '天气预报——只关心明天会不会下雪', weights: [{ dimensionId: 'A2', score: 2 }, { dimensionId: 'V1', score: 1 }] }
    ]
  },
  {
    id: 29,
    ...
    options: [
      ...
      { label: 'B', text: '尽量避免，但也不会因此不敢滑', weights: [{ dimensionId: 'A1', score: 0 }] },
      { label: 'C', text: '我已经囤了三年的护膝，安全是底线', weights: [{ dimensionId: 'A1', score: -2 }, { dimensionId: 'E1', score: 1 }] }
    ]
  },
  {
    id: 30,
    ...
    options: [
      ...
      { label: 'C', text: '天哪好高…我是怎么上来的…能坐缆车下去吗', weights: [{ dimensionId: 'A1', score: -2 }, { dimensionId: 'V1', score: 1 }] }
    ]
  }
]
